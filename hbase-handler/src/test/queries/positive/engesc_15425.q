dfs -cp ${system:hive.root}data/files/engesc15425.avsc ${system:test.tmp.dir}/engesc15425.avsc;
...
'data.frV4.avro.schema.url'='${system:test.tmp.dir}/engesc15425.avsc'
)
TBLPROPERTIES (
